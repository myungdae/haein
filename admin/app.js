...
const RESOURCE_CONFIG = {
  ...
  works:{ title:'창작시', description:'시와 작품을 직접 등록하고 수정합니다.', add:'＋ 새 작품 추가', fields:[['title','제목'],['body','작품 전문','textarea'],['excerpt','짧은 소개 또는 발췌문','textarea'],['published_date','작성일 또는 발표일'],['category','분류'],['image_url','대표 이미지','url'],['video_url','낭송 영상 URL','url'],['audio_url','낭송 음원 URL','url'],['is_featured','메인 대표 작품','checkbox'],['sort_order','정렬 순서','number']] },
